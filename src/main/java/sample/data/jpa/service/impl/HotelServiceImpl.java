...
import sample.data.jpa.domain.entity.City;
import sample.data.jpa.domain.entity.Hotel;
import sample.data.jpa.domain.entity.Review;
import sample.data.jpa.manager.HotelRepository;
import sample.data.jpa.manager.ReviewRepository;
import sample.data.jpa.service.HotelService;
import sample.data.jpa.service.ReviewsSummary;
